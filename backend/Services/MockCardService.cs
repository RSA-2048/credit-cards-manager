...
namespace credit_cards_manager.Tests
{
    public class MockCardService : ICardService
    {
        private List<Card> _cards = new List<Card>
        {
            ...
            new Card { Id = 2, BankId = 2, CardNumber = "2345678901234567", IssueDate = DateTime.Now.AddDays(-730), Image = "/CardImages/credit-card-png-1.png", IsBlocked = true, IsDigital = false, CreditLimit = 10000 },
            new Card { Id = 3, BankId = 3, CardNumber = "3456789012345678", IssueDate = DateTime.Now.AddDays(-1095), Image = "/CardImages/credit-card-png-1.png", IsBlocked = false, IsDigital = true, CreditLimit = 15000 },
            new Card { Id = 4, BankId = 3, CardNumber = "4567890123456789", IssueDate = DateTime.Now.AddDays(-1460), Image = "/CardImages/credit-card-png-1.png", IsBlocked = false, IsDigital = false, CreditLimit = 20000 },
            new Card { Id = 5, BankId = 2, CardNumber = "5678901234567890", IssueDate = DateTime.Now.AddDays(-1825), Image = "/CardImages/credit-card-png-1.png", IsBlocked = true, IsDigital = true, CreditLimit = 25000 },
            new Card { Id = 6, BankId = 1, CardNumber = "6789012345678901", IssueDate = DateTime.Now.AddDays(-2190), Image = "/CardImages/credit-card-png-1.png", IsBlocked = false, IsDigital = true, CreditLimit = 30000 },
            ...
            new Card { Id = 8, BankId = 2, CardNumber = "8901234567890123", IssueDate = DateTime.Now.AddDays(-2920), Image = "/CardImages/credit-card-png-1.png", IsBlocked = false, IsDigital = true, CreditLimit = 40000 },
            new Card { Id = 9, BankId = 3, CardNumber = "9012345678901234", IssueDate = DateTime.Now.AddDays(-3285), Image = "/CardImages/credit-card-png-1.png", IsBlocked = true, IsDigital = false, CreditLimit = 45000 },
            new Card { Id = 10, BankId = 1, CardNumber = "0123456789012345", IssueDate = DateTime.Now.AddDays(-3650), Image = "/CardImages/credit-card-png-1.png", IsBlocked = false, IsDigital = true, CreditLimit = 50000 },
        };
